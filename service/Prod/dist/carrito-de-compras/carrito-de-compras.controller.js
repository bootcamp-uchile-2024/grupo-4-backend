...
let CarritoDeComprasController = class CarritoDeComprasController {
  ...
  create(createCarritoDeCompraDto) {
    const carrito = this.carritoDeComprasService.create(
      createCarritoDeCompraDto,
    );
    if (!carrito) {
      throw new common_1.HttpException(
        'Usuario o producto no existe',
...
__decorate(
  ...
  CarritoDeComprasController.prototype,
  'create',
  null,
);
__decorate(
...
__decorate(
  [
    ...
    __metadata('design:paramtypes', [
      Number,
      update_carrito_de_compra_dto_1.UpdateCarritoDeCompraDto,
    ]),
    __metadata('design:returntype', void 0),
  ],
  CarritoDeComprasController.prototype,
...
exports.CarritoDeComprasController = CarritoDeComprasController = __decorate(
  [
    ...
    __metadata('design:paramtypes', [
      carrito_de_compras_service_1.CarritoDeComprasService,
    ]),
  ],

...
let ProductosController = class ProductosController {
    ...
    create(createProductoDto) {
        ...
        if (!crearProducto) {
            throw new common_1.HttpException('Producto mal creado, ingresalos bien', common_1.HttpStatus.BAD_REQUEST);
        }
    }
    findAll(tipo) {
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Error en los datos enviados' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiQuery)({ name: 'tipo', enum: producto_entity_1.Tipos, required: false, description: 'Filtrar por tipo de producto (opcional)' }),

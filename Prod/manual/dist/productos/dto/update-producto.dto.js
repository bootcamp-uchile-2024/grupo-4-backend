...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Descripción del producto', example: 'Descripción del producto A' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Fecha de creación del producto', example: '2023-01-01T00:00:00.000Z' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Categorías del producto', example: ['Categoría A', 'Categoría B'] }),

...
let PedidoController = class PedidoController {
    ...
    findOne(id) {
        ...
        if (!pedido) {
            throw new common_1.HttpException('Pedido no encontrado', common_1.HttpStatus.NOT_FOUND);
        }
        return pedido;
    }
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Usuario no existe.' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Se entregan pedidos encontrados.' }),
    (0, swagger_1.ApiQuery)({ name: 'tipo', enum: pedido_entity_1.TipoDespacho, required: false, description: 'Filtrar por tipo despacho (opcional)' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Pedido modificado.' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Pedido no encontrado.' }),
    (0, common_1.UsePipes)(new common_1.ValidationPipe({ whitelist: true, forbidNonWhitelisted: true })),
    __param(0, (0, common_1.Param)('id')),

...
const usuario_mappers_1 = require("./mapper/usuario.mappers");
let UsuarioService = class UsuarioService {
    constructor(usuariosRepository, pedidoService) {
    ...
    async findAll() {
        const listadoUsuarios = await this.usuariosRepository.find();
        return usuario_mappers_1.UsuarioMapper.entityListToDtoList(listadoUsuarios);
    }
    findOne(id) {
...
exports.UsuarioService = UsuarioService = __decorate([
    ...
    __param(0, (0, typeorm_2.InjectRepository)(usuario_1.Usuarios)),
    __param(1, (0, common_1.Inject)((0, common_1.forwardRef)(() => pedido_service_1.PedidoService))),

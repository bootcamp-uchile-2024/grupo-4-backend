...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'El carrito fue modificado con éxito.' }),
    (0, swagger_1.ApiResponse)({ status: 500, description: 'Usuario o producto no existe.' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'El carrito fue eliminado con éxito.' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Carrito no encontrado.' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'El estado del carrito fue modificado con éxito.' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Carrito no encontrado.' }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
